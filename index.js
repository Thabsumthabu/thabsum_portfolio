...
const downloadFun = () => {
  window.open(
    "https://drive.google.com/file/d/1RrE0Rggxh_GRls8C0d7t7fuqI0v54UAV/view?usp=sharing"
  );
};

const github = () => {
  window.open("https://github.com/Thabsumthabu", "_blank");
};
const linkedin = () => {
  window.open("https://www.linkedin.com/in/thabsum-pj-b15107335/", "_blank");
};
const twitter = () => {
  window.open("https://x.com/ThabsumPj", "_blank");
};
const instagram = () => {
...
const project1 = () => {
  window.open("https://thabsumthabu.github.io/netflixclone//", "_blank");
};
const github1 = () => {
  window.open("https://github.com/Thabsumthabu/netflixclone", "_blank");
};

const project2 = () => {
  window.open("https://thabsumthabu.github.io/starbucksnewclone/", "_blank");
};
const github2 = () => {
  window.open("https://github.com/Thabsumthabu/starbucksnewclone/tree/master", "_blank");
};
// const project3 = () => {
